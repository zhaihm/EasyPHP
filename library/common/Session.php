...
class Session
{
    ...
    public static function SetMemcacheValue($key, $value, $expire = 0)
    {
        return MemcacheDataManager::getInstance()->setValue('', $key, $value, $expire);
    }
    ...
    public static function deleteSession()
    {
        ...
        $SessionDataManager = self::GetSessionTypeClass();
        $SessionDataManager::getInstance()->cleanSession(self::getSessionId());
    }
